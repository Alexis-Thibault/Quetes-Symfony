 ...
 */
final class Version20220620081051 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD user_id INT DEFAULT NULL, ADD episode_id INT DEFAULT NULL');
